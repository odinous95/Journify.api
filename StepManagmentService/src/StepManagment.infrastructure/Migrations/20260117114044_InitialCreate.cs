        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JounreyName = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "DailyJournies",
                columns: new[] { "Id", "CreatedAt", "JounreyName", "UserId" },
                values: new object[,]
                {
                    ...
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Morning Walk", new Guid("e13b5f1e-7c54-4b01-90e6-d701748f0852") }
                });
